    ...
    <div className="space-y-6">
        ...
        <Card className="p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-xl font-semibold">Vista de Tienda</h2>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium">Tienda Simple</h3>
                  <p className="text-sm text-gray-600">
                    Muestra las categorías como botones grandes en la página principal. 
                    Ideal para usuarios que prefieren una navegación más sencilla.
                  </p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={settings.simpleStoreEnabled}
                  onChange={(e) => setSettings({...settings, simpleStoreEnabled: e.target.checked})}
                  className="sr-only peer"
                />
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              <p className="text-sm text-gray-600">
                <strong>Vista Normal:</strong> Productos con filtros laterales (categorías, marcas, géneros)
              </p>
